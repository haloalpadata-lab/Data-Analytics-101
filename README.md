...
## Contents
* `01_python_basics_and_logic.ipynb` - Fundamentals of Python variables, data types, and a mini BMI Calculator project.
* `02_data_structures_and_loops.ipynb` - (Coming Soon)
